  ...
  switch($bulk_options) {
     ...
     case 'clone':
          ...
          while ($row = mysqli_fetch_array($select_post_query)) {
              ...
              //ova e primer za ako nesto ne se popolni kako avtomatski da se generira nekoj tekst
              if(empty($post_tags)){    
                  
                  $post_tags = "Tags not entered!";
              }
...
<div class="col-xs-4">
    ...
    <a class="btn btn-primary" href="posts.php?source=add_post">Add new</a>
                     ...
                     <?php 
                         //query za posts na View all posts ova e prviot nacin
                              //$query = "SELECT * FROM posts WHERE post_user='$user' ORDER BY post_id DESC";
                         
                         //slednata linija kd e  da se prikazuvaat postovite vo admin samo do momentalniot user ama ovde e menato so joining tables i ne e napraveno
                         
                         //$user=currentUser(); ima funkcija vo functions i se vmetnuva vo gornoto query
                         
                         //Ova e vtoriot nacin SECTION 36 LECTURE 266 so Joining tables vo MySql
...
$row = mysqli_fetch_array($send_comment_query);                         $comment_id = $row['comment_id'];        
...
echo "<td><a class='btn btn-info' href='posts.php?source=edit_post&p_id={$post_id}'>Edit</a></td>";
 ...
 ?>
<!--  brisenje na postovi preku POST dosega bese GET (taka e na drugite mesta users  itn) lecture 277-->
 <form method="post">
