...
<?php $comments_count = count_records(get_all_post_user_comments());?>
<?php $categorie_count = count_records(get_all_user_categories());?>
...
<?php echo "<div class='huge'>".count_records(get_all_user_posts())."</div>" ?>             
...
<?php    
//ova e prviot nacin na zemanje na podatocite i e sement so toj podolu vo edna linija od ko e napraena funkcija 
...
//?>         
      ...
      <div class='huge'><?php echo $comments_count = count_records(get_all_post_user_comments());?></div>  
...
<!--//ovoj cod e trgnat za da ne se gledaat users vo admin (za user so ponizok avtoritet)-->
<!--
...
<?php
/* cel ovoj cod e prepraen so podolniot i pojketo prefrlen vo  funkcija checkStatus i od tuka samo se zadavaat parametrite (tebela,column,kelija(draft ili published))
...
<?php
  // i ovoj nacin e podobrenso toj podolu 
...
//$subscriber_count = checkUserRole('users','user_role','subscriber');  
 ...
 $unapproved_comment_count = count_records(get_all_user_unapproved_comments());
...
$element_count = [$post_counts,$post_published_counts,$post_draft_counts, $comments_count, $approved_comment_count, $unapproved_comment_count, $categorie_count];
...
<script src="https://js.pusher.com/4.1/pusher.min.js"></script>
        ...
        <script>
            ...
            $(document).ready(function(){
                 ...
                 var pusher = new Pusher('857d67edf4c194bfbef2', {
